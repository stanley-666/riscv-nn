...
set_property(CACHE NN_HARDWARE_CONFIG PROPERTY STRINGS V128D128B V256D128B V512D128B GEMMINI)
...
elseif(NOT NN_BACKEND STREQUAL "vector")
  message(FATAL_ERROR "Bare-metal adapters currently require NN_BACKEND=vector or gemmini")
endif()
...
elseif(NN_TESTBENCH STREQUAL "kyber")
  ...
  message(FATAL_ERROR
    "Unsupported bare-metal NN_TESTBENCH='${NN_TESTBENCH}'. Supported: sentence_inference_fp32;sentence_inference_int8;gesture_model;kyber")
endif()
...
target_compile_definitions(${NN_TESTBENCH}_baremetal PRIVATE
  ${NN_BACKEND_DEFINES} BAREMETAL ENABLE_VECTOR=1
  BAREMETAL_CPU_HZ=${NN_BAREMETAL_CPU_HZ}
