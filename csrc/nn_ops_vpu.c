...
void conv1d_i8_vpu_im2col(NNModule *layer, void *input, void *output)
{
    ...
    if (!im2col_input) {
        printf("Error: im2col_input is NULL in conv1d_i8_vpu_im2col.\n");
        exit(EXIT_FAILURE);
    }
...
void conv2d_int8_vpu_im2col(NNModule *layer, void *input, void *output)
{
    ...
    if (!im2col_input) {
        printf("Error: im2col_input is NULL in conv2d_int8_vpu_im2col.\n");
        exit(EXIT_FAILURE);
    }
    ...
    int outW = layer->outputShape.W;
    int outC = layer->outputShape.C;
    int cols = layer->params.conv2d.filterSize * layer->params.conv2d.filterSize * layer->inputShape.C;
