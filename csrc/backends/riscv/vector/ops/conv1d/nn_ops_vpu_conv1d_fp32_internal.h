...
#ifndef _NN_OPS_VPU_CONV1D_FP32_H_
#define _NN_OPS_VPU_CONV1D_FP32_H_

#include "nn_param.h"

#define conv1d_fp32_vpu conv1d_fp32_vpu_m8
...
void conv1d_fp32_vpu_chaining2_nobranch_m8(NNModule *layer, void *input, void *output);
void conv1d_fp32_vpu_chaining4_m8(NNModule *layer, void *input, void *output);
void conv1d_fp32_vpu_chaining4_nobranch_m8(NNModule *layer, void *input, void *output);
void conv1d_fp32_vpu_chaining8_m8(NNModule *layer, void *input, void *output);
void conv1d_fp32_vpu_chaining8_nobranch_m8(NNModule *layer, void *input, void *output);
